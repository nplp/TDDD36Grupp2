...
add_item(name='Pansarvagn', count=10, location='Linkoping')
add_item(name='Pansarvagn', count=70, location='Linkoping')
add_item(name='EMP', count=1, location='Linkoping')
add_item(name='Stege', count=10, location='Linkoping')
add_item(name='El-Verk', count=50, location='Linkoping')
add_item(name='Sjukhustalt', count=15, location='Linkoping')
add_item(name='Tjugomannartalt', count=210, location='Linkoping')
add_item(name='Sovsackar', count=130, location='Linkoping')
add_item(name='Lastbilar', count=37, location='Linkoping')
add_item(name='Diselvarmare', count=59, location='Linkoping')
add_item(name='Sprinterbuss', count=5, location='Linkoping')
m=getUnits()
session.commit()
