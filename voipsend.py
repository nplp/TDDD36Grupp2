...
class GTK_Main:
	...
	def __init__(self):
		...
		window.show_all()
		#HOSTAR!
		self.player1 = gst.parse_launch("v4l2src ! video/x-raw-yuv,width=352,height=288,framerate=8/1 ! hantro4200enc ! rtph263pay ! udpsink host=130.236.218.122 port=5435")
		print "skickar video"
		#CONNECTOR
