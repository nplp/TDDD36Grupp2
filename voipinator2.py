...
class GTK_Main:
	...
	def __init__(self):
		...
		#videoskicka
		self.player2= gst.parse_launch("v4l2src ! video/x-raw-yuv,width=352,height=288,framerate=8/1 ! hantro4200enc !  udpsink host=130.236.218.184 port=5001")
		print "skickar video"
		#Videolyssna
		self.player3 = gst.parse_launch("udpsrc port=5002 caps=application/x-rtp,clock-rate=90000 ! hantro4100dec ! xvimagesink")
		print "lyssnar video"
