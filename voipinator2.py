...
class GTK_Main:
	...
	def __init__(self):
		...
		print "skickar video"
		#Videolyssna
		self.player3 = gst.parse_launch("udpsrc port=5002 ! decodebin name=decoder decoder. ! queue ! audioconvert ! audioresample ! dspilbcsink decoder. ! ffmpegcolorspace ! xvimagesink")
		print "lyssnar video"
