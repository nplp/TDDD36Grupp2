...
class GTK_Main:
	...
	def __init__(self):
		...
		self.player = gst.parse_launch("udpsrc port=4999 caps=audio/x-iLBC,mode=20 ! rtpilbcdepay ! dspilbcsink")
		#Ljudskicka!
		#ta bort caps
		#
		self.player1 = gst.parse_launch("dspilbcsrc dtx=0 ! audio/x-iLBC,mode=20 ! rtpilbcpay ! udpsink host=130.236.218.184 port=5000")
