...
class GTK_Main:
	...
	def __init__(self):
		...
		window.show_all()
		#Ljudlyssna!
		self.player = gst.parse_launch("udpsrc port=4999 ! audio/x-iLBC,rate=8000,channels=1,mode=20 ! rtpilbcdepay ! dspilbcsink")
		#Ljudskicka!
		#ta bort caps
		#
		self.player1 = gst.parse_launch("dspilbcsrc dtx=0 ! audio/x-iLBC,rate=8000,channels=1,mode=20 ! rtpilbcpay ! udpsink host=130.236.218.184 port=5000")
		#videoskicka
		...
		print "skickar video"
		#Videolyssna
		self.player3 = gst.parse_launch("udpsrc port=5002 caps=application/x-rtp,clock-rate=90000 ! rtph263depay ! hantro4100dec ! xvimagesink")
		print "lyssnar video"
