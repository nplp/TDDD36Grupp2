...
class GTK_Main:
	...
	def __init__(self):
		...
		self.player = gst.parse_launch("udpsrc port=4999 !  ! decodebin name=decoder decoder. ! queue ! audioconvert ! audioresample ! osssink decoder. ! ffmpegcolorspace ! xvimagesink")
		#Ljudskicka!
		#ta bort caps
		#
		#self.player1 = gst.parse_launch("dspilbcsrc dtx=0 ! audio/x-iLBC,rate=8000,channels=1,mode=20 ! udpsink host=130.236.218.184 port=5000")
