...
class GTK_Main:
	...
	def __init__(self):
		...
		window.show_all()
		#HOSTAR
		#self.player= gst.parse_launch("gst-launch -v -m autoaudiosrc ! audioconvert ! audioresample ! rtph263pay ! udpsink host=130.236.219.251 port=5434")
		#print "skickar video"
		#Connectar
		self.player1 = gst.parse_launch("filesrc location=/home/TDDD36Grupp2/Bach.ogg ! tcpclientsink host=130.236.218.122 port=3000")
		print "Skickar ljud"
