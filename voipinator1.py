...
class GTK_Main:
	...
	def __init__(self):
		...
		window.show_all()
		#Ljudlyssna!
		self.player = gst.parse_launch("udpsrc port=5000 ! audio/x-iLBC ! dspilbcsink")
		#Ljudskicka!
		self.player1 = gst.parse_launch("dspilbcsrc dtx=0 ! audio/x-iLBC ! udpsink host=130.236.249. port=4999")
